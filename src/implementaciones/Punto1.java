...
public class Punto1 {
	 ...
	 * correctamente, o no. Algunos de sus métodos devuelven el objeto Respuesta, 
	 * que contiene dos elementos: un booleano que determina la correctitud de ejecución 
	 * y un entero que informa lo solicitado por el método en sí, si el método lo requiere 
	 * y su ejecución fue satisfactoria. Su especificación se muestra en el anexo.
	 */
